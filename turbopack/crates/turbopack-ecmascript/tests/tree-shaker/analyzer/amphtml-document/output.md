...
graph TD
    ...
    N7["Items: [ItemId(0, ImportBinding(1))]"];
    N8["Items: [ItemId(0, ImportBinding(2))]"];
    N9["Items: [ItemId(1, ImportBinding(0))]"];
    N10["Items: [ItemId(1, ImportBinding(1))]"];
    N11["Items: [ItemId(1, ImportBinding(2))]"];
    N12["Items: [ItemId(1, ImportBinding(3))]"];
    N13["Items: [ItemId(1, ImportBinding(4))]"];
    N4 --> N3;
    N0 --> N5;
    N0 --> N4;
    N0 --> N3;
...
## Part 2
```js
import { b as Document } from "__TURBOPACK_PART__" assert {
...
import { e as _jsx } from "__TURBOPACK_PART__" assert {
...
export { _jsx as e } from "__TURBOPACK_VAR__" assert {
    __turbopack_var__: true
};
