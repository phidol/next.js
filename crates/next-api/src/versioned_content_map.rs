...
impl VersionedContentMap {
    ...
    // Two pages that share a dynamic import, open page a, navigate to b, delete page b's dynamic
    // import. Navigate to page a.
